...
const routes: Routes = [
  ...
  {path: 'table', component: TableauComponent, canActivate: [AdminGuard ]},
  {path: 'registre', component: RegisterComponent},
  {path: 'pres', component: PresentationComponent},
  {path: 'admin', component: AdminComponent, canActivate: [AdminGuard ] },
  {path: 'dash', component: MatBoardComponent, canActivate: [AdminGuard ]},
  {path: 'gpark', component: GparkComponent, canActivate: [AdminGuard ]},
